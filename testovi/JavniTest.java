...
public class JavniTest {
    ...
    public static double test(Funkcionalnosti f){
        ...
        trenutnoVreme = Date.valueOf("2016-02-01");
        ...
        trenutnoVreme = Date.valueOf("2016-02-15");
        ...
        f.izmeniOcenuZaZaposlenogNaPoslu(idZ2P1, 8);
        f.izmeniOcenuZaZaposlenogNaPoslu(idZ3P1, 6);
        f.izmeniOcenuZaZaposlenogNaPoslu(idZ2P2, 8);
        f.izmeniOcenuZaZaposlenogNaPoslu(idZ3P2, 4);
        
        if(f.dohvatiProsecnuOcenuZaZaposlenog(listaZaposlenih.get(2)).compareTo(new BigDecimal(8)) == 0)
            procenata += 10;
        if(f.dohvatiProsecnuOcenuZaZaposlenog(listaZaposlenih.get(3)).compareTo(new BigDecimal(5)) == 0)
            procenata += 10;
        ...
        trenutnoVreme = Date.valueOf("2016-11-20");
        ...
        BigDecimal a = trajanjeRadaZ2P1.divide(trajanjePosla1,3,RoundingMode.HALF_UP);
        ...
        trenutnoVreme = Date.valueOf("2016-12-10");
